...
#####  <center><a href="https://www.codecogs.com/eqnedit.php?latex=\[&space;min\sum_{i=1}^{K}\sum_{x\in&space;C_i}||x-\mu_i||^2&space;\]" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\[&space;min\sum_{i=1}^{K}\sum_{x\in&space;C_i}||x-\mu_i||^2&space;\]" title="\[ min\sum_{i=1}^{K}\sum_{x\in C_i}||x-\mu_i||^2 \]" /></a></center>
